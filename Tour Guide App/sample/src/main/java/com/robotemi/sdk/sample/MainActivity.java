...
public class MainActivity extends AppCompatActivity implements
    ...
    public void goTo(View view) {
        robot.speak(TtsRequest.create("I will now take you to the " + Data.LocationData.get(0).Name, true));
    }
    ...
    public void onTtsStatusChanged(TtsRequest ttsRequest) {
        ...
        if (ttsRequest.getSpeech().equals(("I will now take you to the " + Data.LocationData.get(0).Name)) && ttsRequest.getStatus().toString().equals("COMPLETED")) {
...
//                robot.speak(TtsRequest.create("Completed", false));
                if (location.toLowerCase().equals(Data.LocationData.get(0).Name.toLowerCase())) {
