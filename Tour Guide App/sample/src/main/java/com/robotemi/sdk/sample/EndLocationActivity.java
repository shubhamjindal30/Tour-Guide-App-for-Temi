...
public class EndLocationActivity extends AppCompatActivity implements
        Robot.NlpListener,
    ...
    public void onNlpCompleted(NlpResult nlpResult) {
        ...
        Toast.makeText(EndLocationActivity.this, nlpResult.action, Toast.LENGTH_SHORT).show();
    ...
    public void onTtsStatusChanged(TtsRequest ttsRequest) {
        ...
        if (ttsRequest.getSpeech().equals(("I will now take you to the " + location)) && ttsRequest.getStatus().toString().equals("COMPLETED")) {
//            String str1 = Data.LocationData.get(0).Name;
            robot.goTo(location.toLowerCase().trim());
        }

        if (ttsRequest.getSpeech().equals("I will now go back to the Entrance.") && ttsRequest.getStatus().toString().equals("COMPLETED")) {
